...
{ 
    ...
    public class Plane : MonoBehaviour
    {
        ...
        void UpdateThrust()
        {
            Rigidbody.AddRelativeForce((Throttle * maximumThrust) * Vector3.forward);
            //.AddRelativeForce(Vector3.forward * (minThrust + (maximumThrust * Throttle)) * forceMult, ForceMode.Force);
        }
